...
# Configuration
JSON_DIR="/root/data/part6-8_high_density_110k/"
OUTPUT_DIR="/root/lutaojiang/data/tokenized/mv_condition_part6-8_multires384-768"
...
# MODE="multi_view2"
# IMAGE_DIR="/root/zhenyang/datasets/GC_vlm_final/image_nano_test_output"
# To use multi_view3 mode (single front view, requires IMAGE_DIR/<scene>/front.png):
# MODE="multi_view3"
